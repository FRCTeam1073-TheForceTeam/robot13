...
StallableAnalogEncoder* RobotMap::climberChainsawElevationMEncoder = NULL;
...
#warning "Magic Numbers Practicing Dark Magic"
	//Do not asssign anything to Digital IDs 3 and 5; they are used as power sources
    ...
    velocity1 = new DigitalInput(1,1);
    velocity2 = new DigitalInput(1, 2);
