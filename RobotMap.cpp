...
DigitalInput* RobotMap::shooterElevatorTopSwitch = NULL;
DigitalInput* RobotMap::shooterElevatorBottomSwitch = NULL;
...
void RobotMap::init() {
	...
	shooterElevatorTopSwitch = new DigitalInput(1, 3);
	lw->AddSensor("Shooter", "ElevatorTopSwitch", shooterElevatorTopSwitch);
	
	shooterElevatorBottomSwitch = new DigitalInput(1, 4);
	lw->AddSensor("Shooter", "ElevatorBottomSwitch", shooterElevatorBottomSwitch);
